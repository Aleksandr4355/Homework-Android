...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etRegisterEmail = findViewById(R.id.edit_text_register_email);
        etRegisterPassword = findViewById(R.id.edit_text_register_password);
        btnRegisterUser = findViewById(R.id.et_register_user);
        etRegisterUname = findViewById(R.id.edit_text_register_uname);
