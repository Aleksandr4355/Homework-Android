...
public class ScreenGamePlayerPlayer5x5 extends AppCompatActivity {
    ...
    private void perFormAction(ImageView imageView, int selectedBoxPosition) {
        ...
        if (activePlayer == 1) {
            ...
            if (checkResult()) {
//                ResultDialog resultDialog = new ResultDialog(ScreenGamePlayerPlayer5x5.this, playerOneName.getText().toString() + " is a Winner!", ScreenGamePlayerPlayer5x5.this);
...
//                ResultDialog resultDialog1 = new ResultDialog(ScreenGamePlayerPlayer5x5.this, "Match Draw", ScreenGamePlayerPlayer5x5.this);
...
//                resultDialog1.show();
            ...
            if (checkResult()) {
//                ResultDialog resultDialog = new ResultDialog(ScreenGamePlayerPlayer5x5.this, playerTwoName.getText().toString() + " is a Winner!", ScreenGamePlayerPlayer5x5.this);
//                resultDialog.setCancelable(false);
//                resultDialog.show();
