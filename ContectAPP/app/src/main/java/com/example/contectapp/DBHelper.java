...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ModelContact> getSearchContact(String orderBy){
        ArrayList<ModelContact> contactList = new ArrayList<>();
        SQLiteDatabase db  = getReadableDatabase();
        String queryToSearch = "SELECT * FROM " + Contacts.TABLE_NAME + " WHERE " + Contacts.C_NAME + " ORDER BY " + orderBy;
